...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.rms2307.ecommerce.resources")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API do App de Sistema de Pedidos", "", "Versão 1.0", "https://www.udemy.com/terms",
				new Contact("Robson de Moraes Silva", "udemy.com/user/nelio-alves", "rms2307@outlook.com"),
				"Em desenvolvimento", "https://www.udemy.com/terms", Collections.emptyList());
	}
